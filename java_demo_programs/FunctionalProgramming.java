...
// public interface ApplePredicate extends FruitPredicate {
//     // abstract function
...
// class AppleImpl implements ApplePredicate {
...
// class Apple extends AppleAbstract {
...
public class FunctionalProgramming {
    ...
    // public static List<Apple> filterApples(List<Apple> apples, String color, int
    // weight, boolean flag) {
    // List<Apple> result = new ArrayList<>();
    ...
    public static void main(String[] args) {
        ...
        // List<Apple> result = filterApples(list, (Apple apple) -> apple.getWeight() >
        // 100);
